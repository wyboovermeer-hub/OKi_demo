...
#
# NOTE: This file was previously named main.py — renamed to
# kiosk.sh because it is a bash script, not Python.
# A .py file containing bash will break any Python import.
# ============================================================
